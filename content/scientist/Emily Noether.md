  ...
  "key_contributions": [
    {
      ...
      "summary": "Noether's theorem states that for every continuous symmetry of a physical system there is a corresponding conservation law. For example, if a physical process exhibits the same outcomes regardless of location or time, then it is symmetric under continuous translations in space and time respectively. By Noether's theorem, these symmetries account for the conservation laws of linear momentum and energy within this system, respectively."
    }
  ],
  "citations": [
