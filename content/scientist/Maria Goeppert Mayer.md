  ...
  "key_contributions": [
    {
      ...
      "summary": "Developed the nuclear shell model, a theoretical framework that describes how protons and neutrons arrange themselves in discrete energy levels within an atomic nucleus, similar to electron shells in atoms. She introduced the concept of 'magic numbers' (2, 8, 20, 28, 50, 82, and 126), which correspond to especially stable configurations of nucleons [CITE 1]."
    },
    {
      "title": "Manhattan Project",
      "summary": "Contributed to the development of the atomic bomb during World War II at Los Alamos, assisting in isotope separation and nuclear fission research."
    }
  ],
  "citations": [
